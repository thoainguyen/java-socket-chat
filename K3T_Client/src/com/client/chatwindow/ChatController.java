...
public class ChatController implements Initializable {
    ...
    private String userNow; // Moi thoi diem chi co 1 user truc tiep

    public void setUserNow(String userN) {
        userNow = userN;
        chatPane = listener.listview.get(userNow);
    }
    ...
    public synchronized void addToOtherChat(Message msg, ListView lv) {
        ...
        othersMessages.setOnSucceeded(event -> {
            lv.getItems().add(othersMessages.getValue());
        });
