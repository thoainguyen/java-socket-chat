...
public class Listener implements Runnable{
    ...
    public HashMap<String, ListView<Task<HBox>>> listview;// Them boi Thoai ngay 13/10/18 9:17pm
 ...
 */
    ...
    public void sendTo(String msg , String name) {
        ...
        ListView lv = listview.get(name);
        controller.addToMyChat(createMessage,lv);
